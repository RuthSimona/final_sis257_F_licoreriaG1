...
const fechaTransaccion = ref(new Date().toISOString().substring(0, 10)); // Campo para la fecha de la transacción
...
async function crearCliente() {
  try {
    const response = await http.post('clientes', { nombre: nombre.value, apellido: apellido.value, cedulaIdentidad: cedulaIdentidad.value });
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 text-center mt-3 mb-3">
        <h2 class="simpsons-font">Crear Nueva Venta</h2>
      </div>
    </div>
    ...
    <div class="row">
      <form @submit.prevent="crearDetalles">
        <div class="form-floating mb-3">
          ...
          <button type="button" class="btn btn-link" @click="crearClienteModal = true">Crear Nuevo Cliente</button>
        </div>
        
        <div class="form-floating mb-3">
          <input type="date" class="form-control" v-model="fechaTransaccion" placeholder="Fecha de Transacción" required />
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="apellido" v-model="apellido" placeholder="Apellido"
                required />
              <label for="apellido">Apellido</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="cedulaIdentidad" v-model="cedulaIdentidad"
                placeholder="Cédula de Identidad" maxlength="20" required />
